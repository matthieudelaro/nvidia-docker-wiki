...
Use `make deb` to manually generate the deb package in `tools/dist`, you will need the packages `dh-make` and `devscripts`. Use `dpkg -i` to install the deb, as shown in the section above.
